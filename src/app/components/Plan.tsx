...
const Plan = ({
  ...
  return (
    <div className="relative flex flex-col items-center gap-2">
      ...
      <p
        className={`w-fit text-center text-xs font-semibold uppercase rounded-full border-[1.5px] px-3 py-1 ${
          type === "limited"
            ? "text-lime-400 border-lime-400 mt-8"
            : "text-cyan-500 border-cyan-500 mt-4"
        }`}
      >
        {name}
      </p>
