...
const Social = ({ href, icon: Icon }: SocialPorps) => {
  return (
    <Link
      href={href}
      className="w-8 h-8 flex-center rounded-full bg-radial-blue-gradient ring-1 ring-blue-950 ring-offset-1 ring-offset-slate-950 cursor-pointer"
    >
      <Icon />
    </Link>
  );
    ...
    <div className="flex flex-col-reverse md:flex-row md:mt-16 mx-auto">
      <div className="w-full md:w-1/2 px-4 pt-16 pb-8 md:p-16 md:pb-8">
        <div className="flex flex-col gap-4 items-center md:items-start">
          ...
          <Link href="#faq" className="text-slate-400 text-xl font-semibold">
            FAQ
          </Link>
          <Link
            href="#download"
