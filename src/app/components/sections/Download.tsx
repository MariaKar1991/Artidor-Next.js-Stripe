...
const Download = () => {
  return (
    <div
      className="flex flex-col p-8 lg:p-16 mt-24 md:mt-0 overflow-x-hidden 2xl:overflow-x-visible"
      id="download"
    >
      <div className="relative flex flex-col md:flex-row items-center mb-96 md:mb-0 md:h-[550px]">
        <div className="w-72 flex flex-col gap-8 mb-36 md:mb-0">
          <Logo size="lg" />
          <p className="p">
            Try it now for free on iOS, Android, PC, and Web. Choose your
            platform and get started today!
          </p>
