...
const Hero = () => {
  return (
    <div className="w-full flex flex-col md:flex-row items-center justify-between p-16 pt-20 md:pt-40 gap-20 relative">
      {/* adds gradient in the back of the robot image */}
      ...
      <div className="flex flex-col gap-2 z-10 md:max-w-80 lg:max-w-96">
        ...
        <p className="p mb-4">
          Experience a user-friendly, fast, and efficient video editing tool
          that&apos;s also surprisingly powerful, enabling you to create
          stunning video quickly, without compromising on quality.
        </p>
